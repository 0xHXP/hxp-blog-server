...
public class WeChatController {
    ...
    private final Pattern pattern = Pattern.compile("(?i)^HXP\\d{4}$");
    ...
    public String handleMsg(HttpServletRequest request) {
        ...
        try {
            ...
            if (WxConsts.XmlMsgType.TEXT.equals(message.getMsgType())){
                ...
                System.out.println("内容内容内容: "+content);
                System.out.println("内容内容内容: "+content.toLowerCase());

                //登录逻辑 todo 登陆
                if (content.toLowerCase().contains("hxp")) {
