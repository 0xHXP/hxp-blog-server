...
import com.hxp.config.properties.*;
import com.hxp.dto.Captcha;
import com.hxp.dto.EmailRegisterDto;
import com.hxp.dto.LoginDTO;
import com.hxp.dto.user.LoginUserInfo;
import com.hxp.entity.SysConfig;
import com.hxp.entity.SysRole;
import com.hxp.enums.LoginTypeEnum;
import com.hxp.mapper.SysConfigMapper;
import com.hxp.service.AuthService;
import com.hxp.entity.SysUser;
import com.hxp.enums.MenuTypeEnum;
import com.hxp.exception.ServiceException;
import com.hxp.mapper.SysMenuMapper;
import com.hxp.mapper.SysRoleMapper;
import com.hxp.mapper.SysUserMapper;
import com.hxp.utils.*;
...
public class AuthServiceImpl implements AuthService {
    ...
    public String getWechatLoginCode() {
        //随机获取4位数字
        String code = "HXP" + (int) ((Math.random() * 9 + 1) * 1000);
    ...
    public void authLogin(AuthCallback callback,String source, HttpServletResponse httpServletResponse) throws IOException {
        ...
        if (response.getData() == null) {
            ...
            httpServletResponse.sendRedirect("http://blog.hexp.online/");
            return;
        }
        ...
        StpUtil.login(user.getId());
        httpServletResponse.sendRedirect("http://blog.hexp.online/?token=" + StpUtil.getTokenValue());
    }
        ...
        switch (source) {
            ...
            case "qq":
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .clientSecret(qqConfigProperties.getAppKey())
