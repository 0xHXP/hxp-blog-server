...
import com.hxp.entity.FilePartDetail;
import com.hxp.mapper.FilePartDetailMapper;
...
public class FilePartDetailService extends ServiceImpl<FilePartDetailMapper, FilePartDetail> {
    ...
    public void deleteFilePartByUploadId(String uploadId) {
        remove(new LambdaQueryWrapper<FilePartDetail>().eq(FilePartDetail::getUploadId, uploadId));
    }
